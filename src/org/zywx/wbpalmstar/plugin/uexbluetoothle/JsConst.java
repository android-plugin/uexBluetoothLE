...
public class JsConst {
    ...
    public static final String ON_CHARACTERISTIC_READ = "uexBluetoothLE.onCharacteristicRead";
    public static final String ON_CHARACTERISTIC_CHANGED = "uexBluetoothLE.onCharacteristicChanged";
    public static final String ON_CHARACTERISTIC_WRITE = "uexBluetoothLE.onCharacteristicWrite";
